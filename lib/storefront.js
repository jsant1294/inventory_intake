...
function normalizeProduct(row) {
  ...
  const images = Array.isArray(row.product_images) ? [...row.product_images].sort((a, b) => {
    if ((a.is_primary ? 0 : 1) !== (b.is_primary ? 0 : 1)) return (a.is_primary ? 0 : 1) - (b.is_primary ? 0 : 1);
